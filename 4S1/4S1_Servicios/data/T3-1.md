...
- Consulta Recursiva
	...
	- Es el NS el encargado de contactar a otrso
- Consulta Iterativa
---
## Implementación BIND
- *Nameservers* (proceso `named`)
	- Son complejos. LLevando a cabo la mayor parte de la resolución.
- Resolvers (funcionalidad `gethostbyname()`)
	- Son simples. Usan una biblioteca, no son un proceso.
	- Hace las consultas necesarias a NS e interpreta las respuestas para devolver un resultado.
---
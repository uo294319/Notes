...
### DNS Caché
- **Def**. NS mantiene en memoria:
	- Las respuestas servidas (positivas y negativas)
	- Las IPs de otros NS consultados
- Usa el campo `TTL` para descartar datos antiguos permitiendo la propagación de cambios.
---
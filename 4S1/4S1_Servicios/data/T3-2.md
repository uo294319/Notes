...
2. `SSH-USERAUTH`. **Autenticación de cliente**
	1. **(Opción 1) *Keyboard Interactive* o Contraseña**
		1. El cliente pide una contraseña al usuario, la envía al servidor y este la verifica.
		2. Ventaja: No requiere setup inicial
		3. Desventaja: Pide contraseña en cada sesión. No permite trabajo desatendido.
	2. **(Opción 2) Clave pública**
		...
		2. Ventajas: No se transmiten secretos y configurable al lado del servidor.
		3. Desventajas: Clave privada en cliente está protegida por contraseña.
		4. Solución: Agentes SSH
...
3. `SSH-CONNECT`. **Creación de Canales**
	...
	4. Todos mensajes en la misma conexión TCP cifrada y multiplexada con el número de canal.
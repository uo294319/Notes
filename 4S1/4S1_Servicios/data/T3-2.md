...
| 253    | `0xFD` | WILL                       | Solicita característica descrita en siguiente byte.                           |
| 252    | `0xFC` | WON'T                      | Rechaza característica en siguiente byte.                                     |
| 251    | `0xFB` | DO                         | Acepta característica en siguiente byte.                                      |
| 250    | `0xFB` | DO                         | Acepta característica en siguiente byte.                                      |

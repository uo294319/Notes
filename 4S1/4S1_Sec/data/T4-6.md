...
- **802.1X**
	...
	- Cada entidad usa dos canales
		...
		- Canal de datos en puerto controlado
			- Solo permite intercambio PDUs para suplicantes auth (y claves instaladas)
	- EAPOL (EAP Over LAN)
		- Empieza con EAPOL-Start
		- Mismos intercambios de mensaje que EAP 
		- Finaliza con EAPOL-Logoff
### Fase 3. Key Management
- Solo si la autenticación fue satisfactoria.
- STA, AP y AS disponen de misma Pairwise Master Key (PMK)
- Tipos claves. Parejas (unicast) o grupos (multicast)
- La distribución de claves se realiza mediante nonces (números aleatorios de un solo uso)
### Fase 4. Protected Data Transfer
- TKIP= Temporal Key Integrity Protocol
- CCMP= Counter Mode-CBC MAC Protocol
- CGMP= Galois/Counter Mode Protocol

...
sequenceDiagram
	...
	Note over Cliente,Servidor: Clave + Auth Cliente (*)
...
1. Partes obligatorias
	...
	3. `ServerKeyExchange` y `ClientKeyExchange` comparten la clave a usar.
	4. `ChangeCipherSpec` Pasa opciones de Pending a
2. Dependiendo de escenario
	1. Si solo comunicaciones cifradas no se hace ninguna de las partes opcionales `(*)`
	2. 
...
---
## Combinación de ESP y AH
- ESP con auth
	- ESP-transporte con auth. No protege (cifra) cabecera IP
	- ESP-túnel con auth. Cifra y autentica cabecera y datos
- Combinación AH y ESP en transporte
	- Primero cifra ESP (SA interna) y luego autentica con AH (SA externa)
- Combinación AH Transporte y ESP túnel
	- Primero autentica con AH en transporte y luego se cifra con un túnel ESP
...
- Adaptado a ordenamiento jurídico español
	- Ley Reguladora de los Servicios Electrónicos de Confianza (LRSEC)
- **Regula**
	- Medios de identificación electrónica
	- Certificados electrónicos
	- Servicios de Confianza (Autoridades de Certificación)
...
- *Principios (solo AAPP)*
	- Interoperabilidad como cualidad integral
	- Carácter multidimensional (organizativa, semántica y técnica)
	- Soluciones multilaterales
- **Aspectos**
	- Infraestructuras y servicios comunes
	- Comunicaciones (Red SARA)
	- Reutilización y transferencia de datos
	- Firma electrónica y certificados
	- Recuperación y conservación de documentos electrónicos.
---
...
- **Disposiciones**
	- Uso de caracteres de las lenguas oficiales de España
	- Extensión de servicios de banda ancha
	- Mejora de los niveles de seguridad
	- Necesidades de información para fines estadísticos y de análisis
	- Acceso de las personas con discapacidad a las TIC
	- Transferencia tecnológica (CENATIC)
	- Cesión de contenidos para ponerlos a disposición de la sociedad
	- Regulación de juego y apuestas en internet
---

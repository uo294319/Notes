...
- Generaciones
	...
	- Segunda
		- Heurísticos o basados en reglas (bloques enteros de código frecuentes en virus)
		- Comprueban integridad de programas. Checksum cifrado para evitar recalculaciones.
	- Tercera
		- Monitorizan actividades y detectan virus por sus acciones.
		- No hace falta una base de datos para firmas o reglas, solo unas pocas acciones.
		- Pueden ser:
			- Trampas para actividades
			- Monitores de Actividades/comportamientos
			- Bloqueadores de comportamiento
	- Cuarta
		- Combinan varias de las técnicas anteriores
---
